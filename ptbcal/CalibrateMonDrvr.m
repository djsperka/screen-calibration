function cal = CalibrateMonDrvr(cal, USERPROMPT, whichMeterType, blankOtherScreen, syncMode)
...
% 4/3/2025  djs     Add syncMode arg. Without this, 'on' is effectively hard-coded. 
...
for a = 1:cal.describe.nAverage
    for i = 1:cal.nDevices
        ...
        % Measure ambient
        darkAmbient1 = MeasMonSpd(window, [0 0 0]', cal.describe.S, syncMode, whichMeterType, theClut);
        ...
        darkAmbient2 = MeasMonSpd(window, [0 0 0]', cal.describe.S, syncMode, whichMeterType, theClut);
