function cal = CalibrateAmbDrvr(cal,USERPROMPT,whichMeterType,blankOtherScreen,syncMode)
...
for a = 1:cal.describe.nAverage
    % Measure ambient
    ambient = ambient + MeasMonSpd(window, [0 0 0]', cal.describe.S, syncMode, whichMeterType, theClut);
end
