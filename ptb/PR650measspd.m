...
% 11/27/24 djs  Make timeout longer for work in EEG booth. WHY SO MUCH TIME
% NEEDED?
...
% Initialize
% DJS change timeout to 60 from 30.
timeout = 60;
...
try
    ...
    fprintf('got exception in PR650rawspd\n');
    getReport(ME)
    psychrethrow(ME);
end
...
fprintf('PR650rawspd - data qual code %d\n', qual);
